# Community Garden — Hackathon build prompt (copy-paste)

Use this block as the **initial system or project prompt** when building the app. For full detail, see [REQUIREMENTS.md](./REQUIREMENTS.md).

---

You are building **Community Garden**, a **web + mobile** marketplace connecting local food producers with consumers and brokers.

**Producers**

- **Home grower** — grows in own garden/backyard; **no license to sell** (model with flags/disclaimers; exact law out of scope).
- **Small farmer** — **licensed** to sell (e.g., farmer’s market).

**Products (MVP):** fruits, vegetables, flowers, eggs — sourced from **garden/backyard**.
